...
class Hero {
  ...
  update(){
    ...
    if(this.y === -28){ //hero made it to the final tile (water)
      this.victory = true;
    }
  }
...
const bug1 = new Enemy(-101, 166, randNum());
const bug2 = new Enemy(-101, 83, randNum());
const bug3 = new Enemy(-101*2.5, 83, randNum());
const allEnemies = [];
